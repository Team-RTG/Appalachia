    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int i2 = 0; i2 < par4; ++i2)
        {
            for (int j2 = 0; j2 < par3; ++j2)
            {
                ...
                if  (aint[j2 + 0 + (i2 + 1) * k1]==Biome.getIdForBiome(Biomes.RIVER)) {
                    aint1[j2 + i2 * par3] = Biome.getIdForBiome(Biomes.RIVER);
                }
                if  (aint[j2 + 2 + (i2 + 1) * k1]==Biome.getIdForBiome(Biomes.RIVER)) {
                    aint1[j2 + i2 * par3] = Biome.getIdForBiome(Biomes.RIVER);
                }
                if  (aint[j2 + 1 + (i2 + 0) * k1]==Biome.getIdForBiome(Biomes.RIVER)) {
                    aint1[j2 + i2 * par3] = Biome.getIdForBiome(Biomes.RIVER);
                }
                if  (aint[j2 + 1 + (i2 + 2) * k1]==Biome.getIdForBiome(Biomes.RIVER)) {
                    aint1[j2 + i2 * par3] = Biome.getIdForBiome(Biomes.RIVER);
                }
            }
        }
