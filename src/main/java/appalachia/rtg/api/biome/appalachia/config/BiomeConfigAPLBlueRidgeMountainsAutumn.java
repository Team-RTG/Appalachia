...
public class BiomeConfigAPLBlueRidgeMountainsAutumn extends BiomeConfigAPLBase {
    ...
    public BiomeConfigAPLBlueRidgeMountainsAutumn() {

        super("blueridgemountainsautumn");
