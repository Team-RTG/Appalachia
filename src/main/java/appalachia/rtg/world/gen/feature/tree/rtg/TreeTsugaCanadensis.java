 ...
 */
public class TreeTsugaCanadensis extends AppalachiaTree {

    World world;
    Random rand;

    public TreeTsugaCanadensis() {
        super();
    ...
    public TreeTsugaCanadensis(boolean shortVersion) {
        this();
    }
    ...
    protected void spawn(World world, int x, int y, int z, IBlockState log, IBlockState leaves) {
        ...
        this.setBlockMetadataWithNotify(x+9, currentY, z+3, 5, 5);
        ...
        this.setBlockMetadataWithNotify(x+0, currentY, z+1, 13, 13);
