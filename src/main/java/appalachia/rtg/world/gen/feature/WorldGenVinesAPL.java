...
public class WorldGenVinesAPL extends WorldGenerator {
    ...
    public WorldGenVinesAPL (Block vineBlock, int maxY, PropertyBool propNorth, PropertyBool propEast, PropertyBool propSouth, PropertyBool propWest) {
