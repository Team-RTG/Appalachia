 ...
 */
public class TreeSycamore extends AppalachiaTree {
    ...
    public TreeSycamore() {
        ...
        this.setFallenLeavesBlock(AppalachiaBlocks.leaves_sycamore_01_fallen.getDefaultState());
    ...
    protected void buildTree(World world, int x, int y, int z, IBlockState log, IBlockState leaves) {
        ...
        this.addTreeLayer((new TreeLayer(++currentY))
            ...
            .setLeaves(
                ...
                new BlockPos(x+16, currentY, z+7),
                new BlockPos(x+16, currentY, z+9),
                new BlockPos(x+17, currentY, z+9),
                new BlockPos(x+3, currentY, z+10),
                new BlockPos(x+15, currentY, z+10),
                new BlockPos(x+3, currentY, z+11),
                new BlockPos(x+15, currentY, z+11),
        ...
        this.addTreeLayer((new TreeLayer(++currentY))
            ...
            .setLeaves(
                ...
                new BlockPos(x+16, currentY, z+6),
                new BlockPos(x+17, currentY, z+6),
                ...
                new BlockPos(x+16, currentY, z+8),
                ...
                new BlockPos(x+5, currentY, z+12),
                new BlockPos(x+6, currentY, z+12),
                new BlockPos(x+15, currentY, z+12),
                new BlockPos(x+16, currentY, z+12),
                new BlockPos(x+17, currentY, z+12),
                new BlockPos(x+3, currentY, z+13),
                new BlockPos(x+4, currentY, z+13),
                new BlockPos(x+5, currentY, z+13),
                new BlockPos(x+15, currentY, z+13),
                new BlockPos(x+5, currentY, z+14),
                new BlockPos(x+6, currentY, z+14),
                new BlockPos(x+9, currentY, z+14),
                new BlockPos(x+14, currentY, z+14),
                new BlockPos(x+15, currentY, z+14),
                ...
                new BlockPos(x+10, currentY, z+15),
                new BlockPos(x+11, currentY, z+15),
                new BlockPos(x+13, currentY, z+15),
                ...
                new BlockPos(x+13, currentY, z+16)
            )
        );
        ...
        this.addTreeLayer((new TreeLayer(++currentY))
            ...
            .setLeaves(
                ...
                new BlockPos(x+16, currentY, z+7),
                new BlockPos(x+18, currentY, z+7),
                ...
                new BlockPos(x+14, currentY, z+8),
                new BlockPos(x+16, currentY, z+8),
                new BlockPos(x+17, currentY, z+8),
                new BlockPos(x+18, currentY, z+8),
                new BlockPos(x+9, currentY, z+9),
                new BlockPos(x+12, currentY, z+9),
                new BlockPos(x+13, currentY, z+9),
                new BlockPos(x+16, currentY, z+9),
                ...
                new BlockPos(x+15, currentY, z+10),
                new BlockPos(x+16, currentY, z+10),
                new BlockPos(x+17, currentY, z+10),
                new BlockPos(x+3, currentY, z+11),
                new BlockPos(x+4, currentY, z+11),
                new BlockPos(x+5, currentY, z+11),
                ...
                new BlockPos(x+14, currentY, z+11),
                new BlockPos(x+16, currentY, z+11),
                new BlockPos(x+17, currentY, z+11),
                new BlockPos(x+5, currentY, z+12),
                ...
                new BlockPos(x+15, currentY, z+13),
                new BlockPos(x+16, currentY, z+13),
        ...
        this.addTreeLayer((new TreeLayer(++currentY))
            ...
            .setLeaves(
                new BlockPos(x+10, currentY, z+0),
                new BlockPos(x+11, currentY, z+0),
                new BlockPos(x+8, currentY, z+1),
                ...
                new BlockPos(x+16, currentY, z+4),
                new BlockPos(x+6, currentY, z+5),
                new BlockPos(x+12, currentY, z+5),
                new BlockPos(x+14, currentY, z+5),
                new BlockPos(x+17, currentY, z+5),
                new BlockPos(x+1, currentY, z+6),
        ...
        this.addTreeLayer((new TreeLayer(++currentY))
            ...
            .setLeaves(
                ...
                new BlockPos(x+14, currentY, z+5),
                new BlockPos(x+16, currentY, z+5),
                new BlockPos(x+4, currentY, z+6),
