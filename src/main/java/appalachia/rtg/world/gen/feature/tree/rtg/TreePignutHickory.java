 ...
 */
public class TreePignutHickory extends AppalachiaTree {

    public TreePignutHickory() {
        super();
        this.setLogBlock(AppalachiaBlocks.log_pignut_hickory_01.getDefaultState());
    ...
    public boolean generate(World world, Random rand, BlockPos pos) {
        ...
        groundPos.add(new BlockPos(x+4, y, z+8));
    ...
    protected void spawn(World world, int x, int y, int z, IBlockState log, IBlockState leaves) {
        ...
        this.setBlockState(new BlockPos(x+4, currentY, z+8), log.withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.NONE));
        currentY++;
