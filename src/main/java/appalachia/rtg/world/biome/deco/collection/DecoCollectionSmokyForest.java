...
public class DecoCollectionSmokyForest extends DecoCollectionBase {
    ...
    public DecoCollectionSmokyForest(boolean fallenTrees) {
        ...
        aplGrandFirTreeOak.logBlock = AppalachiaBlocks.log_hackberry_01.getDefaultState();
        ...
        aplGrandFirTreeChestnut.logBlock = AppalachiaBlocks.log_black_cherry_01.getDefaultState();
        ...
        aplRedMaple.logBlock = AppalachiaBlocks.log_black_locust_01.getDefaultState();
        ...
        papyriferaTreeOak.logBlock = AppalachiaBlocks.log_sycamore_01.getDefaultState();
        ...
        papyriferaTreeSpruce.logBlock = AppalachiaBlocks.log_persimmon_01.getDefaultState();
        ...
        ponderosaOakTree.logBlock = AppalachiaBlocks.log_ash_01.getDefaultState();
        ...
        ponderosaChestnutTree.logBlock = AppalachiaBlocks.log_pignut_hickory_01.getDefaultState();
        ...
        sitchensisTree.logBlock = AppalachiaBlocks.log_hop_hornbeam_01.getDefaultState();
