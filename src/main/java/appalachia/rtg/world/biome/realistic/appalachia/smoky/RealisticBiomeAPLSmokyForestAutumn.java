...
public class RealisticBiomeAPLSmokyForestAutumn extends RealisticBiomeAPLBase {
    ...
    public RealisticBiomeAPLSmokyForestAutumn() {
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceAPLSmokyForestAutumn(config, biome.topBlock, biome.fillerBlock, BlockUtil.getStateDirt(2), 12f, 0.27f);
    }

    public class SurfaceAPLSmokyForestAutumn extends SurfaceBase {

        public IBlockState mixBlock;
        public float width;
        public float height;

        public SurfaceAPLSmokyForestAutumn(BiomeConfig config, IBlockState top, IBlockState filler, IBlockState mix, float mixWidth, float mixHeight) {
