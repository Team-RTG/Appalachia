...
public class RealisticBiomeAPLSmokyHills extends RealisticBiomeAPLBase {
    ...
    public RealisticBiomeAPLSmokyHills() {
    ...
    public TerrainBase initTerrain() {
        ...
        //return new TerrainAPLSmokyHills();
    }

    @Override
    public SurfaceBase initSurface() {

        return new SurfaceAPLSmokyHills(config, biome.topBlock, biome.fillerBlock, BlockUtil.getStateDirt(2), 12f, 0.27f);
    }

    public class SurfaceAPLSmokyHills extends SurfaceBase {

        public IBlockState mixBlock;
        public float width;
        public float height;

        public SurfaceAPLSmokyHills(BiomeConfig config, IBlockState top, IBlockState filler, IBlockState mix, float mixWidth, float mixHeight) {
    ...
    public class TerrainAPLSmokyHills extends TerrainBase {

        protected float hillStrength = 30f;

        public TerrainAPLSmokyHills() {

            this(72f, 30f);
        }

        public TerrainAPLSmokyHills(float bh, float hs) {
