...
public class RealisticBiomeAPLBlueRidgeForest extends RealisticBiomeAPLBase {
    ...
    public RealisticBiomeAPLBlueRidgeForest() {
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceAPLBlueRidgeForest(config, biome.topBlock, biome.fillerBlock, BlockUtil.getStateDirt(2), 12f, 0.27f);
    }
