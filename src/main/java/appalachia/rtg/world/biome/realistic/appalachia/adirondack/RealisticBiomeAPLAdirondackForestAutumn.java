...
public class RealisticBiomeAPLAdirondackForestAutumn extends RealisticBiomeAPLBase {
    ...
    public RealisticBiomeAPLAdirondackForestAutumn() {
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceAPLAdirondackForestAutumn(config, biome.topBlock, biome.fillerBlock, BlockUtil.getStateDirt(2), 12f, 0.27f);
    }

    public class SurfaceAPLAdirondackForestAutumn extends SurfaceBase {

        public IBlockState mixBlock;
        public float width;
        public float height;

        public SurfaceAPLAdirondackForestAutumn(BiomeConfig config, IBlockState top, IBlockState filler, IBlockState mix, float mixWidth, float mixHeight) {
