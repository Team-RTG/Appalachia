...
public class RealisticBiomeAPLAdirondackForest extends RealisticBiomeAPLAdirondackBase {

    public static Biome biome = AppalachiaBiomes.adirondackForest;
    public static Biome river = AppalachiaBiomes.adirondackRiver;

    public RealisticBiomeAPLAdirondackForest() {
    ...
    public TerrainBase initTerrain() {
        ...
        return new TerrainAPLAdirondackForest();
    }

    @Override
    public SurfaceBase initSurface() {

        return new SurfaceAPLAdirondackForest(config, biome.topBlock, biome.fillerBlock, BlockUtil.getStateDirt(2), 12f, 0.27f);
    }

    public class SurfaceAPLAdirondackForest extends SurfaceBase {

        public IBlockState mixBlock;
        public float width;
        public float height;

        public SurfaceAPLAdirondackForest(BiomeConfig config, IBlockState top, IBlockState filler, IBlockState mix, float mixWidth, float mixHeight) {
    ...
    public class TerrainAPLAdirondackForest extends TerrainBase {

        protected float hillStrength = 10f;// this needs to be linked to the

        public TerrainAPLAdirondackForest() {
