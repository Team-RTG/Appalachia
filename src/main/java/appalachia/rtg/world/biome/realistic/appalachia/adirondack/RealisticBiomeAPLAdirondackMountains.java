...
public class RealisticBiomeAPLAdirondackMountains extends RealisticBiomeAPLBase {
    ...
    public static Biome biome = AppalachiaBiomes.adirondackMountains;
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceAPLAdirondackMountains(config, biome.topBlock, biome.fillerBlock, BlockUtil.getStateDirt(2), 12f, 0.27f);
    }

    public class SurfaceAPLAdirondackMountains extends SurfaceBase {

        public IBlockState mixBlock;
        public float width;
        public float height;

        public SurfaceAPLAdirondackMountains(BiomeConfig config, IBlockState top, IBlockState filler, IBlockState mix, float mixWidth, float mixHeight) {
    ...
    public void initDecos() {
        ...
        this.addDecoCollection(new DecoCollectionAdirondackMountains(this.getConfig().ALLOW_LOGS.get()));
    }
    ...
    public class TerrainAPLAdirondackMountains extends FunctionalTerrainBase {
        ...
        public TerrainAPLAdirondackMountains(float mountainWidth, float mountainStrength) {

            this(mountainWidth, mountainStrength, 90f);
        }

        public TerrainAPLAdirondackMountains(float mountainWidth, float mountainStrength, float baseHeight) {
