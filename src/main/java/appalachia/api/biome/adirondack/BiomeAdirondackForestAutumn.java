...
public class BiomeAdirondackForestAutumn extends BiomeAdirondackForest implements IAppalachiaBiome {

    public BiomeAdirondackForestAutumn(BiomeProperties props) {
