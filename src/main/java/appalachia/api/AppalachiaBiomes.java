...
public class AppalachiaBiomes {
    ...
    public static enum AppalachiaBiomeProps {
        ...
        SMOKY_FOREST("Blue Ridge Forest",                           0.1F,   0.1F,   0.34F,  0.8F,   16777215,   false),
        SMOKY_FOREST_AUTUMN("Autumn Blue Ridge Forest",             0.1F,   0.1F,   0.34F,  0.8F,   16777215,   false),
        SMOKY_HILLS("Blue Ridge Hills",                             0.15F,  0.15F,  0.34F,  0.8F,   16777215,   false),
        SMOKY_HILLS_AUTUMN("Autumn Blue Ridge Hills",               0.15F,  0.15F,  0.34F,  0.8F,   16777215,   false),
        SMOKY_MOUNTAINS("Blue Ridge Mountains",                     0.2F,   0.2F,   0.34F,  0.8F,   16777215,   false),
        SMOKY_MOUNTAINS_AUTUMN("Autumn Blue Ridge Mountains",       0.2F,   0.2F,   0.34F,  0.8F,   16777215,   false),
        SMOKY_BOG("Blue Ridge Bog",                                 -0.2F,  0.1F,   0.34F,  0.9F,   16777215,   false),
        SMOKY_BOG_AUTUMN("Autumn Blue Ridge Bog",                   -0.2F,  0.1F,   0.34F,  0.9F,   16777215,   false),
        SMOKY_BEACH("Blue Ridge Beach",                             0.1F,   0.05F,  0.34F,  0.8F,   16777215,   false),
        SMOKY_RIVER("Blue Ridge River",                             0.1F,   0.05F,  0.34F,  0.8F,   16777215,   false);
