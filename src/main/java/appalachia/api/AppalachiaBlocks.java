...
public class AppalachiaBlocks {
    ...
    public static Block door_autumn_brown;
    public static Block door_autumn_charcoal;
    public static Block door_autumn_coffee;
    public static Block door_autumn_grey;
