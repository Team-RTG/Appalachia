...
public class CraftingManager {
    ...
    private static void addShapedRecipes() {
        ...
        GameRegistry.addRecipe(new ItemStack(slab_autumn_brown, 6), "###", '#', planks_autumn_brown);
        GameRegistry.addRecipe(new ItemStack(stairs_autumn_brown, 4), "  #", " ##", "###", '#', planks_autumn_brown);
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(fence_autumn_brown, 3), "#S#", "#S#", 'S', "stickWood", '#', planks_autumn_brown));
        GameRegistry.addRecipe(new ShapedOreRecipe(fence_gate_autumn_brown, "S#S", "S#S", 'S', "stickWood", '#', planks_autumn_brown));
    }
    ...
    private static void addShapelessRecipes() {
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(planks_autumn_brown, 4), new ItemStack(log_autumn_brown, 1, OreDictionary.WILDCARD_VALUE));
    }
    ...
    private static void addSmeltingRecipes() {
        ...
        GameRegistry.addSmelting(log_autumn_brown, new ItemStack(Items.COAL, 1, 1), 0.15F);
    }
}
