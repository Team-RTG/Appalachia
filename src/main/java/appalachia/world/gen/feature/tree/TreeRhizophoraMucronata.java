 ...
 */
public class TreeRhizophoraMucronata extends AppalachiaTree {
    ...
    public TreeRhizophoraMucronata(int minBranches, int maxBranches, float branchLength, float verStart, float verRand) {
    ...
    public TreeRhizophoraMucronata() {
