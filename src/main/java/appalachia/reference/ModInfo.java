...
{
    public static final String MOD_ID = "appalachia"; // DO NOT MODIFY! This gets replaced during gradle build.
    public static final String MOD_NAME = "Appalachia"; // DO NOT MODIFY! This gets replaced during gradle build.
