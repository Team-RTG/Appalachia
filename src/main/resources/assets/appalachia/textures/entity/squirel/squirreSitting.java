...
public Modelsquirrel()
{
     ...
     setTextureOffset("frontRightLeg.frontRightLeg", 49, 21);
     setTextureOffset("frontLeftLeg.frontLeftLeg", 49, 21);
     ...
     Squirrel_head.setRotationPoint(0F, -9F, 5F);
     setRotation(Squirrel_head, -0.4272264F, 0F, 0F);
     ...
     setRotation(Squirrel_body, -1.368186F, 0F, 0F);
     ...
     Squirrel_backRightLeg.setRotationPoint(0.1F, 2F, 7F);
     ...
     Squirrel.setRotationPoint(0F ,21F, -7F);
     ...
     Squirrel_backLeftLeg.setRotationPoint(1.9F, 2F, 7F);
     setRotation(Squirrel_backLeftLeg, 0F, 0F, 0F);
     Squirrel.addChild(Squirrel_backLeftLeg);

     ModelRenderer Squirrel_frontRightLeg = new ModelRenderer(this,"frontRightLeg");
     Squirrel_frontRightLeg.addBox("frontRightLeg", 0F, 0F, -1F, 1, 3, 1);
     Squirrel_frontRightLeg.setRotationPoint(-2F, -8.5F, 3.5F);
     setRotation(Squirrel_frontRightLeg, -0.3005002F, 0F, 0F);
     Squirrel.addChild(Squirrel_frontRightLeg);

     ModelRenderer Squirrel_frontLeftLeg = new ModelRenderer(this,"frontLeftLeg");
     Squirrel_frontLeftLeg.addBox("frontLeftLeg", 0F, 0F, -1F, 1, 3, 1);
     Squirrel_frontLeftLeg.setRotationPoint(2F, -8.5F, 3.5F);
     setRotation(Squirrel_frontLeftLeg, -0.3141593F, 0F, 0F);
     Squirrel.addChild(Squirrel_frontLeftLeg);
     ...
     Squirrel_tail.setRotationPoint(0.5F, 1.7F, 9F);
     setRotation(Squirrel_tail, -0.1364393F, 0F, 0F);
     ...
     tail_tailPieceTop.setRotationPoint(0F, -7F, 0F);
     setRotation(tail_tailPieceTop, -0.6285461F, 0F, 0F);
